...
cdef extern from "btBulletCollisionCommon.h":
    ...
    cdef cppclass btCapsuleShapeZ(btCapsuleShape):
...
cdef extern from "btUserMotionState.h":
    cdef cppclass btUserMotionState(btMotionState):
        btUserMotionState(btTransform(void *), void *)
...
cdef extern from "btBulletDynamicsCommon.h":
    ...
    cdef cppclass btDynamicsWorld(btCollisionWorld):
        ...
        void setInternalTickCallback(void(btDynamicsWorld *, btScalar), void *, bool isPreTick)
